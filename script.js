document.addEventListener('DOMContentLoaded', () => {
  ...
  menuCardsData.forEach(item => {
    const cardHtml = `
      <div class="menu-card bg-gray-800 rounded-2xl overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-2xl group relative cursor-pointer">
  ...
  reviewsData.forEach(review => {
    ...
    `).join('');
    const reviewHtml = `
      <div class="review-card bg-gray-800 rounded-2xl p-8 shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl">
  ...
  pricingData.forEach(plan => {
    const cardHtml = `
      <div class="pricing-card ${plan.highlight ? 'bg-gradient-to-br from-[#ff4b2b] to-[#ff416c] text-white transform scale-105 hover:scale-110 relative z-10' : 'bg-gray-900 text-gray-200'} rounded-2xl p-8 text-center shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl">
